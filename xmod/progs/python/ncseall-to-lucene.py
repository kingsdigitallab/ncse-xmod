...
def writeLuceneXmlFile(faid, mcon, ncon, scon, lucoutpath, lucfcounter, fdoit, fbadocr):
    lucpublfieldslist = []
    lucotherfieldslist = []
...
if __name__ == '__main__':
    ...
    getAllFullartids(articlepath, dbcondic["ncsemetadata"])
    lucfilecounter = 0
    for fullartid in allfullartidsdic:
        print fullartid
        writeLuceneXmlFile(fullartid, dbcondic["ncsemetadata"], dbcondic["ncsegatenee"], dbcondic["semtags"], luceneoutpath, lucfilecounter, filterdoit, filterbadocr)
