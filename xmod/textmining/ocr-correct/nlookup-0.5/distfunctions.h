...
// Counts the number of n-grams that pat and text have in common
// and returns the pattern ngrams minus common ngrams
// (so as to give us a *distance* rather than *similarity* measure)
int gramcount_dist(std::string pat, std::string text, int ngram=2);
