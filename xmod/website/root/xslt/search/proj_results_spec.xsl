...
<!--
  SVN: $Id: proj_results_spec.xsl 1389 2008-06-17 15:52:36Z zau $
-->
        ...
        <xsl:for-each select="//search-results/hits/hit">
          <ul class="s01">
            ...
            <li class="s02">
              ...
              <a href="/Default.htm?href={$path}&amp;entityid={$entity}&amp;view=entity" target="_blank">
                <xsl:text>item</xsl:text>
              </a>
              <xsl:text> | </xsl:text>
              <a href="/Default.htm?href={$path}&amp;page={biblScope[@type = 'page-internal']}&amp;view=document" target="_blank">
                <xsl:text>page</xsl:text>
              </a>
              <xsl:text> | </xsl:text>
              <a href="Default.htm/?href={$path}&amp;page=1&amp;view=document" target="_blank">
